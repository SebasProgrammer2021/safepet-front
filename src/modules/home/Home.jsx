            ...
            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div className="pr-12">
                ...
                <p className="mt-4 text-lg text-white">
                  Todos los servicios que necesites para el cuidado de tus
                  amigos de cuatro patas, seguros, consultas, medicamentos,
                  servicios de emergencias, servicios de spa y estetica entre
                  otros.
                </p>
              </div>
            </div>
